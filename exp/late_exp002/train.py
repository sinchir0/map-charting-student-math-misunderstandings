...
if __name__ == "__main__":
    ...
    # マージして保存
    # base_model_bnb = AutoModelForCausalLM.from_pretrained(
    #     MODEL_NAME, 
    #     quantization_config=quantization_config
    # )
    # merged_model = get_peft_model(base_model_bnb, lora_config)
    # merged_model.merge_and_unload()
    # merged_model.save_pretrained(UPLOAD_PATH)
