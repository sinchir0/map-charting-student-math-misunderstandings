...
EXP_NAME = "exp029_use_misconception_candidate"
MODEL_NAME = "Qwen/Qwen3-8B"
FOLD_PATH = Path("outputs/fold/stratified_folds.json")
DATA_PATH = Path("data")
MISCONCEPTION_CANDIDATE_PATH = Path("outputs/question_id_to_misconception_candidate/question_id_to_misconception_candidate.json")
...
Using the Student Explanation, determine whether the student has a correct understanding, a misconception, or neither.
...
Next, you will be given a list of Misconception Candidates.
If the Student Explanation matches one of these misconceptions, select it from the list.
If it does not match any of them, choose Neither.

Misconception Candidates: {MisconceptionCandidate}
