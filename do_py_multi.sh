...
gcoud auth login
uv run accelerate launch --config_file config/accelerate_config_zero3.yaml exp/$EXP_NAME/train.py --dir $DIR_NAME
...
gcloud compute instances stop saito-gpu-map-calc-multi --zone=us-central1-c --discard-local-ssd=false